...
function hexToRgb(hex) {
  // Changed from hexToRGB to hexToRgb
...
const displayMaterial = new THREE.ShaderMaterial({
  uniforms: {
    ...
    uColor1: {
      value: new THREE.Vector3(...hexToRgb(config.color1)),
    },
    uColor2: {
      value: new THREE.Vector3(...hexToRgb(config.color2)),
    },
    uColor3: {
      value: new THREE.Vector3(...hexToRgb(config.color3)),
    },
    uColor4: {
      value: new THREE.Vector3(...hexToRgb(config.color4)),
    },
    uColorIntensity: {
